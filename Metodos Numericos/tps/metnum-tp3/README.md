...
## Instalacion para plots de basemap

Descargar el ultimo release desde https://github.com/matplotlib/basemap/archive/v1.2.2rel.zip

```
sudo apt-get install libgeos-dev
pip install pillow
pip install ~/Downloads/basemap-v1.2.2rel.zip
```
